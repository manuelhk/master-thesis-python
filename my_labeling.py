...
def get_data(data_path, frames_path):
    ...
    :return:
        - array: data: all signal data from that TestRun
        - list: metadata: names of each signal
        - list: all_vehicles: names of each vehicle (e.g. T0) except the ego vehicle
        - list: images: paths to all images from that TestRun
    """
